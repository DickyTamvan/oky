...
#	os.system("mkdir /results")
	try:
		...
		os.system("echo 'Mozilla/5.0 (Linux; Android 6.0.1; SM-G955F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.120 Mobile Safari/537.36;]' >> .ua.txt")
		os.system("echo 'Mozilla/5.0 (Linux; Android 6.0.1; SM-G955F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.120 Mobile Safari/537.36;]' >> .ua")
	os.system("clear")
	print("""||>>>>> 🅳🅸🅲🅺🆈 🅼🆄🅻🆃🅸 🅱🆁🆄🆃🅴 🅵🅾🆁🅲🅴 <<<<<||
     [▪▪▪|■■■》 [[🅳🅼🅱🅵]] 《■■■|▪▪▪]
╔═════════════════════════════════════════════╗
...
def cookie():
	...
	try:
		...
		'user-agent'                : 'Mozilla/5.0 (Linux; Android 6.0.1; SM-G955F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.120 Mobile Safari/537.36', # Jangan Di Ganti Ea Anjink.
...
def public():
	...
	try:
		...
		exit(' \033[0;97m[\033[0;91m!\033[0;97m] bukan ID publik Njir Tolol!')
	...
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;92mOK\033[0;97m Saved In : results/OK-%s-%s-%s.txt\n"% (ha, op, ta))
...
def reaction():
	...
	if ask == "Y" or ask == "y":
		manual()
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;93mOK\033[0;97m Saved In : results/OK-%s-%s-%s.txt"% (ha, op, ta))
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;92mCP\033[0;97m Saved In : results/CP-%s-%s-%s.txt\n"% (ha, op, ta))
...
def manual():
	...
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;92mOK\033[0;97m Saved In : results/CP-%s-%s-%s.txt"% (ha, op, ta))
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;93mCP\033[0;97m Saved In : results/OK-%s-%s-%s.txt\n"% (ha, op, ta))
